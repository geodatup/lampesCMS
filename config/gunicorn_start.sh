...
DJANGODIR=/var/www/webapps/lampesCMS             # Django project directory
SOCKFILE=/var/www/webapps/lampesCMS/run/gunicorn.sock  # we will communicte using this unix socket
